            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (test1 * test2 * test3 == 1) {
                        Toast.makeText(getApplicationContext(), "등록되었습니다." + Integer.parseInt(time_re), Toast.LENGTH_SHORT).show();
                        con.makeRoom(new RoomInfo(1041051460, content.getText().toString(), place.getText().toString(), Integer.parseInt(time_re)));
